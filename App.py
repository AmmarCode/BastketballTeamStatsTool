...
def balance_team():
    ...
    Panthers[0] = {'team name': 'Panthers', 'name': 'Karl Saygan',
                   'guardians': ['Heather Bledsoe'], 'experience': True,
                   'height': 42}
    Bandits[0] = {'team name': 'Bandits', 'name': 'Les Clay',
                  'guardians': ['Wynonna Brown'], 'experience': True,
                  'height': 42}
    Warriors[0] = {'team name': 'Warriors', 'name': 'Herschel Krustofski',
                   'guardians': ['Hyman Krustofski ', ' Rachel Krustofski'],
                   'experience': True, 'height': 45}
